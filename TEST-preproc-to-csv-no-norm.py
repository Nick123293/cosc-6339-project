...
def step7_split_variant_invariant(
    input_df: pd.DataFrame,
    time_variant_csv: Optional[str],
    time_invariant_csv: Optional[str],
    metadata_json: str,
    time_col: str,
    zip_col: str,
    ...
    return time_variant_df, time_invariant_df, meta
...
def main() -> None:
    ...
    t0 = time.perf_counter()
    current_df, s2 = step2_spatial_impact(
        current_df,
        args.tri_facilities,
        args.tri_chemicals,
        args.zip_shapefile,
    ...
    t0 = time.perf_counter()
    current_df, s3 = step3_add_time_features(
        current_df,
    ...
    t0 = time.perf_counter()
    current_df, s4 = step4_expand_direction_columns(
        current_df,
    ...
    if args.variance_threshold is not None:
        t0 = time.perf_counter()
        current_df, s6 = step6_variance_filter_time_variant_only(
            current_df,
    ...
    if args.output_mode == "split":
        t0 = time.perf_counter()
        time_variant_df, time_invariant_df, s7 = step7_split_variant_invariant(
            current_df,
        ...
        t0 = time.perf_counter()
        final_time_variant_df, s8 = step8_add_past_features_to_time_variant(
            time_variant_df,
        ...
        final_outputs = {
            ...
            "time_variant_shape": list(final_time_variant_df.shape),
            "time_invariant_shape": list(time_invariant_df.shape),
        }
        ...
        t0 = time.perf_counter()
        final_combined_df, s8 = step8_add_past_features_to_time_variant(
            current_df,
        ...
        final_outputs = {
            ...
            "combined_shape": list(final_combined_df.shape),
        }
